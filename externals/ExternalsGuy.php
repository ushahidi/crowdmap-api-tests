...
use Codeception\Module\ExternalsHelper;
...
class ExternalsGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
     *
     * @see Codeception\Module\ExternalsHelper::checkExternalsObjs()
     * @return \Codeception\Maybe
     */
    public function checkExternalsObjs($resp, $external_ids, $new_ids = null, $udpate_ids = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('checkExternalsObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
