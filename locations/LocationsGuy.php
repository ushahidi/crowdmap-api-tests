...
use Codeception\Module\LocationsHelper;
...
class LocationsGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
     *
     * @see Codeception\Module\LocationsHelper::checkLocationObjs()
     * @return \Codeception\Maybe
     */
    public function checkLocationObjs($resp, $location_ids, $new_ids = null, $update_ids = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('checkLocationObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
