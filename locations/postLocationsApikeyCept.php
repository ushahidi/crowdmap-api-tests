...
$I->wantTo('test posts against the locations end-point with only apikey for authentication');
...
$I->sendPost('/locations/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/', 'POST')));
/* $I->seeResponseCodeIs(400); */
$I->seeResponseIsJson();


//test an authenticated request with just the fsq_venue_id. The fsq_venue_id is not already in use.
$I->sendPost('/locations/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/', 'POST'), 'fsq_venue_id' => 1));
...
$I->sendPost('/locations/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/', 'POST'), 'lat' => 37.774929, 'lon' => -122.419416));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60072));

$I->sendGET('/locations/60072/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/60072/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60072));
...
$I->sendPost('/locations/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/', 'POST'), 'geometry' => '{"type": "Point","coordinates": [36.790853,-1.299041]}'));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60073));

$I->sendGET('/locations/60073/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/60073/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60073));
...
$I->sendPost('/locations/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/', 'POST'), 'lat' => 37.446754547281, 'lon' => -77.572746276855, 'name' => 'new test'));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60074));

$I->sendGET('/locations/60074/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/60074/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60074));
...
$I->sendPost('/locations/', array('apikey'=> (string) $I->api_key_for_crowdmap('/locations/', 'POST'), 'lat' => 37.446754547281, 'lon' => -77.572746276855, 'name' => 'new test', 'region' => 'test region'));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$resp = $I->grabResponse();
$I->checkLocationObjs($resp, array(60074));
