...
$I->sendGet('/users/sarahmorden/follows/4981/', array('apikey'=> (string) $I->api_key_for_crowdmap('/users/sarahmorden/follows/4981/', 'GET'));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/users/sarahmorden/follows/4983/', array('apikey'=> (string) $I->api_key_for_crowdmap('/users/sarahmorden/follows/4983/', 'GET'));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
