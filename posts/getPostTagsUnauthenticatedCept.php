...
$I->wantTo('test get request against the /posts/tags(/:tag)/ end-point without authentication');
$I->haveHttpHeader('Content-Type', 'text/html');
$I->haveHttpHeader('User-Agent', 'Api Test/0.1');

/* testing posts tags */
$I->sendGet('/posts/tags');
...
$I->sendGet('/posts/tags', array('count' => true));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
...
$I->sendGet('/posts/tags/cmupdates');
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/posts/tags/cmupdates', array('count' => true));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
...
$I->sendGet('/posts/tags/kachumbari');
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/posts/tags/kachumbari', array('count' => true));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
