...
use Codeception\Module\AccessHelper;
...
class AccessGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
     *
     * @see Codeception\Module\AccessHelper::testSmsNumberAssertions()
     * @return \Codeception\Maybe
     */
    public function testSmsNumberAssertions($apikey, $session, $resource_url, $authorized = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('testSmsNumberAssertions', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
