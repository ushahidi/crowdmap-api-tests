...
use Codeception\Module\MapsHelper;
use Codeception\Module\PostHelper;
use Codeception\Module\UserHelper;
use Codeception\Module\LoginHelper;
use Codeception\Module\AuthHelper;
...
class MapsGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
     *
     * @see Codeception\Module\MapsHelper::checkMapObjs()
     * @return \Codeception\Maybe
     */
    public function checkMapObjs($resp, $map_ids, $new_ids = null, $update_ids = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('checkMapObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\MapsHelper::checkFollowerObjs()
     * @return \Codeception\Maybe
     */
    public function checkFollowerObjs($resp, $follower_ids, $map_ids, $new_ids = null, $update_ids = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('checkFollowerObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\PostHelper::confirmPostCount()
     * @return \Codeception\Maybe
     */
    public function confirmPostCount($resp, $count) {
        $this->scenario->addStep(new \Codeception\Step\Action('confirmPostCount', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\PostHelper::postsArray()
     * @return \Codeception\Maybe
     */
    public function postsArray() {
        $this->scenario->addStep(new \Codeception\Step\Action('postsArray', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\PostHelper::spotCheckObjs()
     * @return \Codeception\Maybe
     */
    public function spotCheckObjs($resp) {
        $this->scenario->addStep(new \Codeception\Step\Action('spotCheckObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\PostHelper::checkPostObjs()
     * @return \Codeception\Maybe
     */
    public function checkPostObjs($resp, $post_ids, $update_ids = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('checkPostObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\UserHelper::checkUserObjs()
     * @return \Codeception\Maybe
     */
    public function checkUserObjs($resp, $user_ids, $update_ids = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('checkUserObjs', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\LoginHelper::logInByUsername()
     * @return \Codeception\Maybe
     */
    public function logInByUsername($username, $password, $apikey) {
        $this->scenario->addStep(new \Codeception\Step\Action('logInByUsername', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\LoginHelper::logInByEmail()
     * @return \Codeception\Maybe
     */
    public function logInByEmail($email, $password, $apikey) {
        $this->scenario->addStep(new \Codeception\Step\Action('logInByEmail', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\LoginHelper::loginWithMalformedParameters()
     * @return \Codeception\Maybe
     */
    public function loginWithMalformedParameters($username, $password, $apikey) {
        $this->scenario->addStep(new \Codeception\Step\Action('loginWithMalformedParameters', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\LoginHelper::getSession()
     * @return \Codeception\Maybe
     */
    public function getSession() {
        $this->scenario->addStep(new \Codeception\Step\Action('getSession', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\AuthHelper::api_key_for_crowdmap()
     * @return \Codeception\Maybe
     */
    public function api_key_for_crowdmap($url, $method) {
        $this->scenario->addStep(new \Codeception\Step\Action('api_key_for_crowdmap', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\AuthHelper::api_key_for_accesscontrol()
     * @return \Codeception\Maybe
     */
    public function api_key_for_accesscontrol($url, $method) {
        $this->scenario->addStep(new \Codeception\Step\Action('api_key_for_accesscontrol', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
