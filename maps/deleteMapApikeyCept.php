...
$I->wantTo('test DELETE request against the /maps/:map_id/ end-point with apikey');
$I->haveHttpHeader('Content-Type', 'text/html');
$I->haveHttpHeader('User-Agent', 'Api Test/0.1');

//test request where user is not map owner
$I->sendDelete('/maps/1/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/1/', 'DELETE')));
...
$I->sendGet('/maps/1/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/1/', 'GET')));
...
$I->sendDelete('/maps/2/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/', 'DELETE')));
$I->seeResponseCodeIs(401);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 401));
$I->seeResponseContainsJson(array('success' => false));
...
//make sure map has not been deleted
$I->sendGet('/maps/2/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/maps/2/posts/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/posts/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$empty_array = array();
...
//make sure posts_maps have not been deleted
$I->sendGet('/posts/8883/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/posts/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
...
$I->sendGet('/maps/2/collaborators/', array('fields'=> 'users.user_id', 'apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/collaborators/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
...
$I->sendGet('/maps/2/settings/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/settings/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
...
$I->sendGet('/maps/2/tags/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/2/tags/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/maps/1/tags/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/tags/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/maps/2/followers/', array('fields'=> 'users.user_id', 'apikey'=> (string) $I->api_key_for_crowdmap('/maps/comunemessina/followers/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/maps/1605/followers/', array('apikey'=> (string) $I->api_key_for_crowdmap('/maps/comunemessina/followers/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/posts/', array('post_ids' => '279,1549', 'apikey'=> (string) $I->api_key_for_crowdmap('/posts', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
...
$I->sendGet('/posts/264/', array('apikey'=> (string) $I->api_key_for_crowdmap('/posts/264/', 'GET')));
$I->seeResponseCodeIs(200);
$I->seeResponseIsJson();
$I->seeResponseContainsJson(array('status' => 200));
$I->seeResponseContainsJson(array('success' => true));
